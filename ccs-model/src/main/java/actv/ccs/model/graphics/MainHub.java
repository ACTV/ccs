...
public class MainHub
{
    ...
    public MainHub(String mainFilePath) throws IOException 
    {
       ...
       //     -0.5f,  -0.25f, 0.5f, 
           // 0f, 0.25f, 0.5f, 
           // 0f,  -0.25f, 0.5f
      shapes = new GeoShape[] { /*new GeoShape("triangle prism", new float[] {
             
           -0.5f,  -0.25f, -0.5f, //triangle prism
            0f, 0.25f, -0.5f, 
            0.5f,  -0.25f, -0.5f,
           ...
           -0.5f, -0.25f, 0.5f
               ...
               // 0.0f, 1.0f,
                ...
                1.0f, 1.0f,
                0.0f, 1.0f
             },mainFilePath + "tex" + File.separator + "wood.jpg",0f,0f,0f)

,  */ /*new GeoShape("3 sided triangle", new float[] {
            
           -0.5f,  -0.5f, -0.25f,  //3 sided triangle
           0f, 0.75f, 0f, 
           0.5f,  -0.5f, -0.25f,
...
, new GeoShape("Cube", new float[] {
            ...
            0.25f,  0.25f,  0.25f, 
            -0.25f,  0.25f,  0.25f,
            -0.25f,  0.25f, -0.25f },null,null,0f,0f,0f)
              
              ,*/
        

            new GeoShape("teapot",mainFilePath + "models" + File.separator + "teapot.obj",mainFilePath + "tex" + File.separator + "tex.jpg",0,0,0)};
         
        /*
         attachedShapes  = new GeoShape[] { new GeoShape("Cube1", new float[] {
            -0.25f,  0.25f, -0.25f, 
            -0.25f, -0.25f, -0.25f, 
            0.25f, -0.25f, -0.25f,   
            0.25f, -0.25f, -0.25f, 
        ...
        //shapes[2].setHericalObject(attachedShapes[0]);
